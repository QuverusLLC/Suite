        ...
        <div id="panel-left-content-container" class="panel-left-content-container">
            <div id="left-body-container" class="left-body-container">
                <div id="left-content-number-container" class="left-content-number-container">
                    <textarea readonly id="lyrics-lines" class="lyrics-lines" style="height: 100%; width: 100%; overflow: hidden; text-align: right; color: #aaaaaa;"></textarea>
                </div>
                <div id="left-content-syllables-container" class="left-content-syllables-container" style="padding-right: 5px;">
                    <textarea readonly id="lyrics-syllables" class="lyrics-syllables" style="height: 100%; width: 100%; overflow: hidden; text-align: right; color: #888888;"></textarea>
                </div>
                <div id="left-content-lyrics-container" class="left-content-lyrics-container">
                    <textarea id="lyrics-textarea" class="lyrics-textarea" placeholder="Type lyrics here" style="height: 100%; width: 100%; overflow: hidden; word-break: break-all;"></textarea>
                </div>
            </div>
        </div>
